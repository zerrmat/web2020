...
public class ExternalHistoricalControllerTest {
    ...
    public void setup() {
        ...
        controller = new ExternalHistoricalController(cacheControlService, externalRequestsService, exchangeService, stockService);
    }
    ...
    public void shouldConsumeResponse() throws JsonProcessingException {
        ...
        List<TickerDto> responseDtos = responseWrapper.extract();
        ...
        Mockito.when(externalRequestsService.makeExternalMarketStackHistoricalRequest(
                any(MarketStackPagination.class), any(String.class))).thenReturn(responseBody);
        Mockito.when(externalRequestsService.makeMarketStackHistoricalRequest(any(String.class), eq(exchangeService)))
                .thenReturn(responseDtos);

        // when
        List<StockDto> result = controller.executeEndpoint(stockSymbol, exchangeSymbol);
